            ...
            <tbody>
                ...
                @foreach ($usuarios as $usuario)
                    <tr>
                        ...
                        <th>
                            <img style="border-radius: 25px; width: 40px; height:40px;"src="{{ $usuario->foto != null ? Storage::disk('public')->url($usuario->foto) : Storage::disk('public')->url('images/usuarios/default.png') }}"
                                alt="">
                        </th>
